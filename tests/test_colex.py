...
def test_find_bad_internal_alignments():
    ...
    wl = Alignments({
        0: [
            ...
            "cogids"],
        1: [
            "a", "a", "bla", "b l a", "b l a -".split(), [1]],
        2: [
            "b", "a", "bla", "b l a k", "b l a k".split(), [1]],
        3: [
            "c", "a", "bla", "b a k", "b - a k".split(), [1]],
        4: [
            "a", "b", "bla", "b l a k", "b l a k".split(), [1]],
        5: [
            "b", "b", "bla", "b l a k", "b l a k".split(), [1]],
        6: [
            "a", "c", "bla", "b l a", "b l a -".split(), [1]],
...
def test_find_colexified_alignments():
    wl = Alignments({
        ...
        3: [
            "c", "a", "bla", "b a k", "b - a k".split(), [1]],
        4: [
            "a", "b", "bla", "b l a k", "b l a -".split(), [2]],
        5: [
            "b", "b", "bla", "b l a k", "b l a k".split(), [2]],
        6: [
            "a", "c", "bla", "b l a", "- b l a".split(), [3]],
        7: [
            "d", "c", "bla", "a b l", "a b l -".split(), [3]]
